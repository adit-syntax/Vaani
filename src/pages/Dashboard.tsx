...
const Dashboard = () => {
  ...
  const { userName, speak, addMessage, commandCount } = useVaani();
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Try saying "Hey Vaani, read my unread emails" or "What's on my schedule today?"
                  Vaani understands natural language, so just speak naturally.
                </p>
              </div>
