  ...
  const sections = [
    {
      ...
      icon: Mic,
      items: [
        { command: '"Hey Vaani"', description: 'Wake up the assistant from idle mode.' },
        { command: '"Stop listening"', description: 'Deactivate the microphone and put Vaani into sleep mode.' },
        { command: '"Repeat that"', description: 'Ask Vaani to repeat the last spoken response.' },
        { command: '"Cancel"', description: 'Immediately abort the current action or clear any active drafts.' },
        { command: '"Pause / Resume"', description: 'Temporarily stop Vaani from speaking or resume a paused sequence.' },
      ],
    },
    {
      ...
      items: [
        ...
        { command: '"Send email to [name]"', description: 'Start the flow to compose a new email. Vaani will ask for details.' },
    ...
    },
    {
      ...
      icon: ShieldCheck,
      details: 'Vaani uses Hybrid Real-Time Security (HRTS) for all authentication.',
      items: [
      ...
      <div className="p-6 lg:p-10 max-w-5xl mx-auto space-y-12 pb-32">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
            Welcome to Vaani, your secure, voice-first personal assistant. This guide covers everything from basic operations to advanced AI-enabled workflows.
          </p>
        </div>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { step: 1, title: 'Wake Word', text: 'Say "Hey Vaani" at any time. The top indicator will pulse blue when active.', icon: Mic },
              ...
              { step: 4, title: 'Confirmation', text: 'Vaani will summarize what it heard and ask for confirmation for actions.', icon: ShieldCheck },
            ].map((s) => (
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-500/20 text-indigo-400 flex items-center justify-center flex-shrink-0 text-[10px]">•</div>
                    <p className="text-muted-foreground"><strong>Correction</strong>: If Vaani mishears you, immediately say "Cancel" or "No, I meant..." to correct the flow.</p>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-6 h-6 rounded-full bg-indigo-500/20 text-indigo-400 flex items-center justify-center flex-shrink-0 text-[10px]">•</div>
          ...
          <Card className="bg-destructive/5 border-destructive/20 h-full">
            ...
            <CardContent className="space-y-4 text-xs text-muted-foreground leading-relaxed">
              <p>
                Vaani transmits voice packets for intent processing. No audio is stored permanently unless "Learning Mode" is explicitly enabled in Settings.
              </p>
              <p>
