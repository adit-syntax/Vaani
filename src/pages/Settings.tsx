          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="bg-card/30 backdrop-blur-sm border-border/50">
              <CardHeader>
                ...
                <CardDescription>Customize the look and feel of Vaani.</CardDescription>
              </CardHeader>
            ...
            <Card className="bg-card/30 backdrop-blur-sm border-border/50">
              <CardHeader>
                ...
                <CardDescription>Fine-tune how Vaani hears and responds to you.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <p className="font-medium">Continuous Listening</p>
                    <p className="text-sm text-muted-foreground">Monitor for "Hey Vaani" in the background.</p>
                  </div>
            ...
            <Card className="bg-card/30 backdrop-blur-sm border-border/50">
              <CardHeader>
                ...
                <CardDescription>Configure how Vaani interacts with your Google account.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
